...
#+begin_src shell :results silent :var user=user-path
  ...
  echo "emacs /home/cpsoz/WF-WK-essai.org --batch -l /home/cpsoz/.emacs.d/init.el --eval "(setq org-confirm-babel-evaluate nil)" --eval "(org-babel-execute-buffer)"" >> $user/datab-rech.sh
