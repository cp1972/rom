...
#+name: trends
#+begin_src python :var dt="/home/cpsoz/ROM-Data/BERT-Analyse/MTA-Results/DT.csv"  :results Trends.pdf file
  ...
  df_trends['Verteidigung'] = df_trends['0'].rolling(15).mean()
  df_trends['Hessen'] = df_trends['1'].rolling(15).mean()
  df_trends['Forsch/Wiss.'] = df_trends['2'].rolling(15).mean()
  df_trends['Apotheken/Med.'] = df_trends['3'].rolling(15).mean()
  df_trends['Energie/Strom/Wirt.'] = df_trends['4'].rolling(15).mean()
  df_trends['Datenschutz'] = df_trends['6'].rolling(15).mean()
  df_trends['Darmstadt/Bildung/Forsch.'] = df_trends['7'].rolling(15).mean()
  df_trends['Energie/Wirt./Optim./Nachhalt.'] = df_trends['8'].rolling(15).mean()
  df_trends['Apotheken/Krankenkass./Med.'] = df_trends['9'].rolling(15).mean()

  sns.lineplot(x="Jahr",y="RM",
           label="Trendthema Var_comment", data=df_comment,
           ci=None, color='darkolivegreen')
  sns.lineplot(x="Jahr",y="RM",
           label="Trendthema Var_decmeth", data=df_decmeth,
           ci=None, color='darkred')
  sns.lineplot(x="Jahr",y="RM",
           label="Trendthema Var_roleissue", data=df_roleissue,
           ci=None, color='steelblue')
  sns.lineplot(x="Jahr",y="RM",
           label="Trendthema Var_selectcrit", data=df_selectcrit,
           ci=None, color='darkgoldenrod')
  sns.lineplot(x="Jahr",y="RM",
           label="Trendthema Var_rolename", data=df_selectcrit,
           ci=None, color='darkorange')
  plt.legend(loc=2, prop={'size':14}, bbox_to_anchor=(1,1),ncol=1)
  plt.ylabel('Rollender Durchschnitt')
  plt.xlabel('Jahre')
  plt.xticks(rotation=45, ha="right")

  plt.savefig('/home/cpsoz/Github/minipublic/images/Trends.pdf', dpi=300, bbox_inches='tight')
